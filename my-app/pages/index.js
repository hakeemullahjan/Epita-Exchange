...
export default function Home() {
  ...
  // `reservedCD` keeps track of the Epita Tokens Reserve balance in the Exchange contract
  ...
  /**
   * swapTokens: Swaps  `swapAmountWei` of Eth/Epita Tokens with `tokenToBeReceivedAfterSwap` amount of Eth/Epita Tokens.
   */
  ...
  /**
   * _getAmountOfTokensReceivedFromSwap:  Returns the number of Eth/Epita Tokens that can be received
   * when the user swaps `_swapAmountWEI` amount of Eth/Epita Tokens.
   */
   ...
   * then we calculate the Epita Tokens he can add, given the Eth he wants to add by keeping the ratios
   * constant
   */
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} Epita Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} Epita LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  type="number"
                  placeholder="Amount of EPITA tokens"
                  onChange={(e) =>
                    setAddCDTokens(
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                  {`You will need ${utils.formatEther(addCDTokens)} Epita Tokens`}
                </div>
                <button className={styles.button1} onClick={_addLiquidity}>
                  Add
                </button>
            ...
            <div>
              ...
              <div className={styles.inputDiv}>
                {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                {`You will get ${utils.formatEther(removeCD)} Epita
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoDevToken">Epita Token</option>
          </select>
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
  ...
  return (
    <div>
      <Head>
        <title>Epita Exchange</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Epita Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Epita Tokens
          </div>
          <div>
            <button
