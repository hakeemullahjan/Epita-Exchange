...
export const calculateCD = async (
  ...
  // The ratio we follow is (amount of Epita Tokens to be added) / (Epita Tokens balance) = (Eth that would be added) / (Eth reserve in the contract)
  // So by maths we get (amount of Epita Tokens to be added) = (Eth that would be added * Epita Tokens balance) / (Eth reserve in the contract)
